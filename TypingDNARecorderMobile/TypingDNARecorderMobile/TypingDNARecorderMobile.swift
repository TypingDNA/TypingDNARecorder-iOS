...
// DO NOT MODIFY
@objc(TypingDNARecorderMobile)
open class TypingDNARecorderMobile: NSObject {
    ...
    public override init() {
        TypingDNARecorderMobile.log(message: "[TypingDNA] Creating the recorder...", level: 1);
        if (!TypingDNARecorderMobile.initialized) {
            TypingDNARecorderMobile.log(message: "[TypingDNA] The recorder was not initialized...", level: 1);
            TypingDNARecorderMobile.initialized = TypingDNARecorderMobile._initialize();
        }
    }
